...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    category: "education",
    tagline: "Coursework attempt at a zero-code backend/server generator",
    description: {
  ...
  },
  {
    ...
    description: {
      hr: "Bachelor's thesis project — a news aggregator built and shipped in roughly a month of focused work, backed by a real production-style setup.",
      ...
      tech: "Go backend (his first project in the language) with ElasticSearch, PostgreSQL and a Next.js/React/Redux Toolkit/RTK Query frontend deployed on Vercel. Full observability stack: logs in ELK, tracing in Jaeger, metrics in Prometheus/Grafana, and Yandex.Metrica for traffic. CI/CD auto-deployed to a rented Docker host on every merged PR.",
    },
    stack: ["Go", "ElasticSearch", "PostgreSQL", "Next.js", "React", "Redux Toolkit", "Docker", "Prometheus", "Grafana", "Jaeger", "ELK"],
    links: [{ label: "Live site", url: "https://prospero-frontend.vercel.app/" }],
  },
  {
