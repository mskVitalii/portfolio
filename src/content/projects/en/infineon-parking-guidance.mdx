...
**Situation:** Infineon's Dresden campus has hundreds of parking spaces across several lots. The company was evaluating commercial parking-guidance vendors — the best quote came in at €480,000/year in licensing and maintenance fees.

**Task:** Build an in-house alternative — hardware to dashboard — for a fraction of that recurring cost.

**Action:** Built embedded firmware for license-plate recognition and occupancy counting running directly on IP cameras, Python backend services to aggregate zone occupancy, a C# device-management layer, and a React dashboard for real-time visibility.

**Result:** €480,000/year saved versus the vendor quote. The barrier-control subsystem now independently serves 8,000 registered users, with 3,000 monthly active.
