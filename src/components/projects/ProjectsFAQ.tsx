...
/** Same collapsible-accordion pattern as the /hire-me FAQ, scoped to
 * questions about reading these project case studies. */
export function ProjectsFAQ() {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold">{t("faqSectionTitle")}</h2>
